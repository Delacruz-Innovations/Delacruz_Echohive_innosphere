        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8 items-baseline">
          ...
          <div>
            <div className="w-32 mb-4">
              <img src={logo} alt="Delacruz Innovations" />
            </div>
  ...
  <div className="mb-4 p-3 bg-yellow-900/50 border border-yellow-600 rounded-lg text-yellow-400 text-sm">
          ...
          <div className="md:text-right space-y-6">
            ...
            <div className="flex gap-3 md:justify-end">
              <a 
                ...
                className="w-11 h-11 rounded-full bg-white text-black flex items-center justify-center hover:bg-purple-700 hover:text-white transition-all duration-300"
                aria-label="LinkedIn"
              >
    ...
    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
               ...
               <a 
                ...
                className="w-11 h-11 rounded-full bg-white text-black flex items-center justify-center p-2 hover:bg-purple-700 hover:text-white transition-all duration-300"
                aria-label="TikTok"
              >
