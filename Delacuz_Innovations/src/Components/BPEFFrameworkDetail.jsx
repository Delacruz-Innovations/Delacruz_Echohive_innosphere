  ...
  return (
    <section className="bg-black px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <HorizontalScrollRow>
          <div ref={stagesRef} className="contents">
            {servicesData.bpefProcess.map((stage) => {
              const Icon = stageIcons[stage.number];
              return (
                <div
                  key={stage.number}
                  className="w-[85vw] shrink-0 snap-start rounded-3xl border border-white/10 bg-gray-900/60 p-6 transition-colors duration-300 hover:border-purple-400/60 sm:w-[440px] sm:p-8"
                >
