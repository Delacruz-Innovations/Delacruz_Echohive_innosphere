          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-100">Online - I am here to help</p>
              </div>
            </div>
              ...
              <div className="p-4 bg-white border-t border-gray-200">
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white rounded-lg p-2 transition-colors"
